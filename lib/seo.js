...
export function webPageSchema({ name, description, path, locale, pageType = 'WebPage', dateModified }) {
  return {
    '@context': 'https://schema.org',
    '@type': pageType,
    name,
...
export function articleSchema({ headline, description, path, locale, datePublished, dateModified }) {
