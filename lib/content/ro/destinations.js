...
export const destinations = {
    ...
    sections: {
      voip: {
        ...
        body: [
          ...
          'Dacă un anumit eSIM de călătorie este afectat depinde de felul în care planul respectiv rutează traficul și se poate schimba. Tratează cu rezervă orice pagină care îți promite apeluri WhatsApp nelimitate în Emirate. Inclusiv pe a noastră: scriem ce face un plan când putem verifica și scriem că nu știm când nu știm.',
      ...
      costuri: {
        ...
        body: [
          'Emiratele sunt în afara oricărei zone de roaming inclusă în abonamentele românești. Pachetele zilnice către Golf sunt printre cele mai scumpe din lista de prețuri a oricărui operator.',
        ],
      },
      acoperire: {
        heading: 'Acoperire',
  ...
  egypt: {
    ...
    metaDescription: 'Egiptul este în afara roamingului UE. Pe coasta Mării Roșii rețelele sunt bune, în deșert nu. Un eSIM de călătorie costă mult mai puțin decât roamingul.',
    sectionOrder: ['intro', 'costuri', 'acoperire', 'instalare', 'limite', 'alternative', 'faq'],
    intro: [
      'Egiptul este una dintre destinațiile de charter clasice pentru turiștii din România și este complet în afara roamingului european. Telefonul funcționează, dar la tarifele de roaming internațional din abonamentul tău.',
  ...
  thailand: {
    ...
    sections: {
      ...
      costuri: {
        ...
        body: [
          'Thailanda este în afara oricărei zone incluse în abonamentele românești. Pachetele zilnice către Asia de Sud-Est sunt scumpe raportat la ce cumperi cu aceiași bani pe loc.',
        ],
      },
    },
    faq: [
  ...
  morocco: {
    angle: 'Marocul pare aproape de Europa, dar pentru abonamentul tău este destinație extra-UE',
    h1: 'eSIM pentru Maroc',
    title: 'eSIM Maroc: Marrakech, Fes și deșertul fără facturi de roaming',
    metaDescription: 'Marocul nu este în roamingul UE. În medina din Marrakech și Fes internetul pe telefon ajută la orientare, în deșert dispare. Ce rezolvă un eSIM de date și ce nu.',
    sectionOrder: ['intro', 'tarife', 'orase', 'sud', 'spania', 'numar', 'faq'],
    intro: [
      'Marocul este la trei ore de zbor de Europa, iar asta îi face pe mulți să creadă că telefonul merge ca în Spania. Nu merge. Marocul nu este stat membru UE și nu intră în roamingul inclus în abonamentele românești.',
      'Pentru un city break la Marrakech sau un circuit prin țară, datele mobile contează mai mult decât în alte destinații, din motive practice pe care le explicăm mai jos.',
    ],
    sections: {
      tarife: {
        heading: 'Ce spune abonamentul tău despre Maroc',
        body: [
          'Operatorii din România trec Marocul la destinații internaționale, cu taxă pe zi, pachet separat sau preț pe megabyte. Verifică în aplicația operatorului înainte de plecare. Dacă ai deja un pachet care include Marocul, s-ar putea să nu ai nevoie de altceva.',
        ],
      },
      orase: {
        heading: 'De ce ai nevoie de date în medina',
        body: [
          'Medina din Marrakech și cea din Fes sunt labirinturi de străduțe înguste, cu ziduri înalte între care GPS-ul sare. O hartă cu poziția ta în timp real te scoate din ele mai repede decât orice indicație primită pe drum.',
          'Riadurile au de obicei wifi, dar zidurile groase îl opresc înainte să ajungă în cameră. Pe terasă merge, în cameră mai rar.',
        ],
      },
      sud: {
        heading: 'Munții Atlas și deșertul',
        body: [
          'Maroc Telecom, Orange Maroc și Inwi acoperă bine orașele mari și drumurile principale. Pe trecătorile din Atlasul Înalt și în taberele din deșert, lângă Merzouga, semnalul slăbește sau dispare. Descarcă hărțile înainte să pleci spre sud.',
        ],
      },
      spania: {
        heading: 'Dacă vii din Spania',
        body: [
          'Pe coasta de sud a Spaniei, lângă Tarifa, telefonul se poate conecta la o antenă marocană de peste strâmtoare. Atunci plătești roaming în Maroc deși ești încă în Spania. Alege manual o rețea spaniolă pe acea porțiune de coastă.',
        ],
      },
      numar: {
        heading: 'Date, nu număr marocan',
        body: [
          'Un eSIM de călătorie îți dă internet, nu un număr cu prefix +212. Pentru WhatsApp cu riadul sau cu șoferul e suficient. Dacă un serviciu local îți cere cod prin SMS, ai nevoie de o cartelă marocană cu număr, care se cumpără din aeroport, cu pașaportul.',
        ],
      },
    },
    faq: [
      { q: 'Merge roamingul românesc în Maroc?', a: 'Merge, dar la tarif internațional, nu la cel din UE. Verifică opțiunea de roaming a abonamentului înainte de plecare.' },
      { q: 'Am semnal în tabăra din deșert?', a: 'Rareori. Uneori pe o dună din apropiere, în cort aproape deloc. Consideră noaptea în deșert offline.' },
      { q: 'Pot folosi WhatsApp cu șoferul sau cu riadul?', a: 'Da. WhatsApp merge pe orice conexiune de date, deci și pe eSIM. Nu ai nevoie de număr marocan pentru asta.' },
    ],
  },

  albania: {
    angle: 'Pentru români Albania este destinație de drum cu mașina prin Balcani, toată în afara UE',
    h1: 'eSIM pentru Albania',
    title: 'eSIM Albania: drumul prin Balcani și plajele din sud',
    metaDescription: 'Albania nu este în roamingul UE, la fel ca Serbia, Muntenegru și Macedonia de Nord. Pentru un drum cu mașina prin Balcani, un eSIM regional este mai simplu.',
    sectionOrder: ['intro', 'drum', 'tarife', 'coasta', 'corfu', 'numar', 'faq'],
    intro: [
      'Tot mai mulți români merg vara în Albania, cu avionul la Tirana sau cu mașina prin Serbia, Macedonia de Nord sau Muntenegru. Pe acest drum ieși din roamingul UE la prima graniță după România și nu mai intri înapoi până acasă.',
      'Albania nu este stat membru UE, deci gigabaiții din abonament nu te însoțesc acolo.',
    ],
    sections: {
      drum: {
        heading: 'Drumul cu mașina prin Balcani',
        body: [
          'Serbia, Macedonia de Nord, Muntenegru și Albania sunt toate în afara UE. La fiecare graniță telefonul schimbă rețeaua și operatorul te taxează după zona în care e încadrată țara respectivă.',
          'Pentru un asemenea traseu, un eSIM regional pentru Balcani acoperă mai multe țări cu un singur plan și te scutește de cumpărat câte o cartelă la fiecare graniță.',
        ],
      },
      tarife: {
        heading: 'Cât te costă roamingul',
        body: [
          'Operatorii români încadrează Albania la destinații extra-UE. Unii au pachete pentru Balcanii de Vest, alții taxează pe zi sau pe megabyte. Verifică în aplicație înainte de plecare, pentru că diferențele între abonamente sunt mari.',
        ],
      },
      coasta: {
        heading: 'Pe coastă și la munte',
        body: [
          'Vodafone Albania și One Albania acoperă bine Tirana, Durrës, Vlora, Saranda și Ksamil. Pe pasul Llogara semnalul se întrerupe pentru scurt timp.',
          'În Alpii Albanezi, la Theth și Valbona, traseele sunt în mare parte fără semnal. Pensiunile au de obicei wifi, potecile nu.',
        ],
      },
      corfu: {
        heading: 'Dacă treci și prin Corfu',
        body: [
          'Pe coasta de nord-est a insulei Corfu, telefonul se poate conecta la rețele albaneze. Ești în Grecia, deci în UE, dar factura arată roaming în Albania. Alege manual o rețea grecească pe acea parte a insulei.',
        ],
      },
      numar: {
        heading: 'Nu primești număr albanez',
        body: [
          'eSIM-ul de călătorie îți dă doar date. Nu îți dă număr cu prefix +355 și nu primește SMS-uri de la servicii locale. Pentru asta îți trebuie o cartelă albaneză cu număr.',
        ],
      },
    },
    faq: [
      { q: 'Albania este în roamingul UE?', a: 'Nu. Albania este țară candidată, nu stat membru, deci roamingul inclus din UE nu se aplică acolo.' },
      { q: 'Un singur eSIM pentru Serbia, Muntenegru și Albania?', a: 'Un plan regional pentru Balcani le poate acoperi pe toate. Verifică lista exactă de țări înainte de cumpărare.' },
      { q: 'De ce am plătit roaming în Albania când eram în Corfu?', a: 'Antenele albaneze ajung până pe coasta de nord-est a insulei. Alege manual o rețea grecească acolo.' },
    ],
  },
};
