export const guides = {
  ...
  'esim-vs-roaming': {
    ...
    metaDescription: 'În Uniunea Europeană roamingul este inclus. În afara ei, socoteala durează două minute și de obicei nu este la limita.',
    intro: [
      'Pentru abonamentele românești răspunsul în Uniunea Europeană este aproape mereu roaming, pentru că nu costă nimic în plus. În afara Uniunii este aproape mereu invers.',
    ...
    sections: {
      ...
      afara: {
        heading: 'În afara Uniunii se scumpește repede',
        body: [
      ...
      rezonabil: {
        ...
        body: [
          'Roamingul inclus este gândit pentru călătorii, nu pentru a trai permanent în altă țară cu un abonament românesc. Operatorii pot analiza tiparul de utilizare pe o perioada de luni și pot cere dovada legăturii cu țară de origine, pot aplica un cost suplimentar sau pot limita serviciul.',
    ...
    faq: [
      ...
      { q: 'Dar apelurile primite?', a: 'Vin pe numărul tău ca de obicei. În Uniunea Europeană primirea este inclusă, în afara ei nu automat.' },
    ...
    sections: {
      wifi: {
        ...
        body: [
          ...
          'Și se oprește la ușa terminalului. Taxiul, trenul spre oraș și căutarea hotelului se întâmplă în afara lui.',
        ],
      },
      codul: {
        ...
        body: [
          ...
          'Numărul tău românesc poate să îl primească, dar numai dacă linia s-a înregistrat într-o rețea de acolo. Dacă ai lăsat telefonul în modul avion de la decolare sau ai oprit de tot linia de acasă ca să nu plătești nimic în afara Uniunii, nu s-a înregistrat nicăieri și codul nu are unde să ajungă. Iar chiar înregistrat, multe formulare acceptă doar numere în format local și resping din start unul care începe cu +40.',
