...
export const regions = {
  europe: {
    ...
    sections: {
      ...
      goluri: {
        ...
        body: [
          ...
          'Albania, Serbia, Bosnia și Herțegovina, Macedonia de Nord și Muntenegru sunt în aceeași situație. Destinații europene de vacanță, toate în afara zonei de roaming.',
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Este în afara zonei de roaming, deși este în mijlocul Europei. Cei care trec cu mașina spre Italia observă asta abia pe factură.',
      },
    ],
  },
  ...
  'south-america': {
    ...
    sections: {
      ...
      etape: {
        ...
        body: [
          'Traseele de aici sunt făcute din puține etape lungi, nu din multe scurte. Un autocar de noapte de la Lima la Cusco sau un zbor intern de la Buenos Aires la El Calafate sunt lucruri obișnuite, și ambele se petrec în mare parte în afara acoperirii.',
  ...
  'middle-east': {
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'În Golf, surprinzător de bună, inclusiv pe traseele agențiilor. În afara lui, se subțiază.',
      },
      {
    ...
    faq: [
      {
        ...
        a: 'Pentru că este aproape de Europa, intens vizitat și în afara oricărei înțelegeri europene de roaming.',
      },
      {
  ...
  balkans: {
    ...
    title: 'eSIM Balcanii: în Europa, în afara zonei de roaming',
    metaDescription:
      'Serbia, Albania, Bosnia, Macedonia de Nord și Muntenegru sunt în Europa și în afara roamingului inclus. De aici vine toată cererea.',
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Nu la tarif național. Serbia este în afara zonei, deși este țară vecină.',
      },
      {
