    ...
    sections: {
      operator: {
        ...
        body: [
          ...
          'O spunem direct, în loc să completăm câmpurile acelea cu ceva care sună credibil. O politica ce sugerează o persoana juridică acolo unde nu există una induce în eroare exact omul pe care ar trebui să îl protejeze.',
      ...
      destinatari: {
        ...
        body: [
          ...
          'Google poate prelucra date în afara Spațiului Economic European. Aceste transferuri se bazează pe decizia de adecvare a Comisiei Europene pentru Statele Unite și, acolo unde nu se aplică, pe clauze contractuale standard.',
        ],
      },
      durata: {
    ...
    sections: {
      ...
      statistica: {
        ...
        body: [
          ...
          'Microsoft Clarity ar intra tot în grupa aceasta. Este pregătit în cod, dar inactiv, deci momentan nu setează nimic.',
        ],
      },
      marketing: {
        heading: 'Marketing',
