...
export const destinations = {
  ...
  spain: {
    angle: 'Spain is inside the EU roaming zone, so the answer depends on whether your plan comes from the US, the UK or the EU, and on the borders you cross',
    h1: 'eSIM for Spain',
    title: 'eSIM for Spain: what US and UK travellers need to check',
    metaDescription: 'EU phone plans already work in Spain. US and UK plans vary. What a travel eSIM for Spain covers, and the borders where your phone can switch networks.',
    sectionOrder: ['intro', 'whoneeds', 'borders', 'islands', 'networks', 'limits', 'faq'],
    intro: [
      'Spain is one of the easiest countries in Europe to stay connected in. Cities, the coast and the main motorways have strong 4G and wide 5G coverage, and hotels, cafes and trains usually offer wifi on top.',
      'Whether you need a travel eSIM depends less on Spain than on where your phone plan comes from. A plan from an EU country already works here at home prices under EU roaming rules. A plan from the United States or the United Kingdom may or may not, and that is where a travel data plan earns its place.',
    ],
    sections: {
      whoneeds: {
        heading: 'US, UK and EU plans are three different answers',
        body: [
          'From the United States, some plans include data in Spain, often at a reduced speed, while others charge a daily pass for every day you use the phone. Over a two week trip a daily pass adds up to more than most travel data plans.',
          'From the United Kingdom, EU roaming is no longer guaranteed. Several UK networks charge a daily fee for using your allowance in Spain, and others still include it on some tariffs. Check your own tariff before you fly.',
          'From an EU country, you normally do not need an eSIM for Spain at all, unless your home allowance is small or your operator applies a fair use limit to long stays.',
        ],
      },
      borders: {
        heading: 'Gibraltar and Andorra are not Spain',
        body: [
          'Gibraltar is a British territory and Andorra sits outside the EU. Neither is covered by EU roaming rules. Near La Linea, in the Pyrenees and on day trips across either border, your phone can connect to a local network there and bill you at non EU rates. If you plan to cross, pick the Spanish network manually in your phone settings, or check that your plan lists those places.',
        ],
      },
      islands: {
        heading: 'The Balearic and Canary Islands',
        body: [
          'Both island groups are part of Spain and of the EU, so the same plan covers them. Coverage in the resort towns is good. On ferries between the islands and the mainland, your phone may switch to a ship network, which is not covered by EU roaming rules and can be expensive. Flight mode at sea is the safe default.',
        ],
      },
      networks: {
        heading: 'The networks',
        body: [
          'Movistar, Vodafone and MasOrange, which now combines Orange and Yoigo, run the main national networks. Digi is building its own network and still uses a national roaming agreement in places. A travel eSIM connects to one or more of these, and in cities the difference is small.',
        ],
      },
      limits: {
        heading: 'No Spanish number',
        body: [
          'A data eSIM gives you mobile data, not a Spanish +34 number. Restaurants, tour operators and taxis in Spain commonly use WhatsApp, which works over data, so most visitors never miss a local number.',
        ],
      },
    },
    faq: [
      { q: 'Will my US plan charge me by the day in Spain?', a: 'Some US plans do, through a daily pass. Others include data in Spain at reduced speed. Check the plan details before you travel.' },
      { q: 'Do I need an eSIM for Spain with a UK plan?', a: 'Only if your network charges for EU roaming or your allowance is small. Several UK networks charge a daily fee, so compare that with a data plan for the whole trip.' },
      { q: 'Will a Spain eSIM work in Gibraltar or Andorra?', a: 'Not automatically. Both are outside the EU. Check whether your plan lists them before you cross the border.' },
    ],
  },

  greece: {
    angle: 'Greece is an island trip, and the costly surprises happen at sea and near the Turkish coast',
    h1: 'eSIM for Greece',
    title: 'eSIM for Greece: islands, ferries and the Turkish coast',
    metaDescription: 'Mainland Greece and the big islands are well covered. Ferries and islands near Turkey are where phones run up bills. What a travel eSIM for Greece covers.',
    sectionOrder: ['intro', 'whoneeds', 'turkishcoast', 'ferries', 'islands', 'networks', 'faq'],
    intro: [
      'Most trips to Greece combine Athens with one or more islands. Athens, Thessaloniki and the popular islands such as Crete, Rhodes, Corfu, Santorini and Mykonos have good 4G and growing 5G coverage in towns and resorts.',
      'The problems travellers actually run into are not about coverage on land. They happen on the ferry between islands and on the islands that sit a few kilometres from Turkey, where a phone can quietly connect to a network that is not in the EU.',
    ],
    sections: {
      whoneeds: {
        heading: 'Who needs a travel eSIM for Greece',
        body: [
          'An EU phone plan already works in Greece at home prices. A UK plan may carry a daily EU roaming fee depending on the network and tariff. US plans range from included data at reduced speed to a daily pass. If your plan charges by the day, a data plan for the whole trip is usually the cheaper way to cover two weeks of island hopping.',
        ],
      },
      turkishcoast: {
        heading: 'Rhodes, Kos, Samos, Chios and Lesvos',
        body: [
          'These islands lie close to the Turkish coast. On beaches and headlands facing Turkey, a Turkish network can have the stronger signal, and your phone may join it without asking. Turkey is outside the EU, so data used there is billed at non EU roaming rates, even on an EU plan.',
          'The fix takes a minute: in your phone settings, turn off automatic network selection and choose Cosmote, Vodafone or Nova. If you plan a day trip to Bodrum, Kusadasi or Cesme, use a plan that lists Turkey as well as Greece.',
        ],
      },
      ferries: {
        heading: 'Ferries are not covered by EU roaming',
        body: [
          'EU roaming rules apply to land networks only. On many ferries and cruise ships, once you are out of range of the coast, your phone can connect to an onboard network routed by satellite, which is billed separately and can be very expensive. Put the phone in flight mode at sea, or turn off data roaming, and use the ship wifi if you need to be online.',
        ],
      },
      islands: {
        heading: 'Small islands and the mountains',
        body: [
          'Smaller islands and the mountain interior of Crete and the Peloponnese have gaps, especially between villages. Download offline maps and ferry tickets before you leave a town.',
        ],
      },
      networks: {
        heading: 'The networks',
        body: [
          'Cosmote, Vodafone and Nova run the three Greek networks. Cosmote is the largest. A travel eSIM connects to one or more of them, and on the smaller islands the choice of network can matter more than on the mainland.',
        ],
      },
    },
    faq: [
      { q: 'Why did my phone connect to a Turkish network in Greece?', a: 'On islands close to Turkey the Turkish signal can be stronger. Select a Greek network manually to stay on EU rates.' },
      { q: 'Does EU roaming work on Greek ferries?', a: 'Not on satellite networks on board. Use flight mode or ship wifi while at sea.' },
      { q: 'Is one eSIM enough for Athens and the islands?', a: 'Yes, a Greece plan covers the whole country. Coverage varies by island, not by plan.' },
    ],
  },

  italy: {
    angle: 'Italy is a multi city rail trip, so the questions are the Swiss border, San Marino and how your plan is billed abroad',
    h1: 'eSIM for Italy',
    title: 'eSIM for Italy: Rome, Florence, the lakes and the borders',
    metaDescription: 'Italy has good coverage in its cities and on the main rail lines. What a travel eSIM for Italy covers for US and UK travellers, and where Swiss networks can take over.',
    sectionOrder: ['intro', 'whoneeds', 'lakes', 'microstates', 'trains', 'networks', 'faq'],
    intro: [
      'A typical first trip to Italy moves between Rome, Florence and Venice by train, often with a few days on the Amalfi Coast or at the northern lakes. The cities and the high speed rail lines are well covered, and mobile data is what most visitors use for maps, tickets and bookings.',
      'For travellers from the EU, the home plan already works. For travellers from the United States and the United Kingdom, the question is how your plan bills you abroad, and whether a single data plan for the whole trip costs less.',
    ],
    sections: {
      whoneeds: {
        heading: 'US and UK plans',
        body: [
          'Some US plans include data in Italy at reduced speed, others charge a daily pass. Several UK networks charge a daily fee for EU roaming on many tariffs. If you are billed by the day, a travel data plan usually costs less over a trip of a week or more.',
        ],
      },
      lakes: {
        heading: 'Lake Como, Lake Maggiore and the Swiss border',
        body: [
          'Around Lake Como, Lake Maggiore and in the Alpine valleys, Switzerland is close. Switzerland is not in the EU and is not covered by EU roaming rules, so a phone that joins a Swiss network can be billed at non EU rates. Select an Italian network manually in these areas, and if you take the train to Lugano or St. Moritz, check that your plan includes Switzerland.',
        ],
      },
      microstates: {
        heading: 'Vatican City and San Marino',
        body: [
          'In Vatican City your phone uses the Italian networks, so nothing changes. San Marino has its own network and is outside the EU. Some plans include it and others do not, which matters if you stay there rather than pass through on a day trip from Rimini.',
        ],
      },
      trains: {
        heading: 'On the train',
        body: [
          'High speed trains between Milan, Florence, Rome and Naples have onboard wifi and mostly good mobile coverage, with short drops in the Apennine tunnels. Regional lines along the coast and in the mountains have more gaps. Keep tickets and maps offline.',
        ],
      },
      networks: {
        heading: 'The networks',
        body: [
          'TIM, Vodafone, WindTre and Iliad run the Italian mobile networks. Vodafone Italia is now part of Fastweb and still operates under the Vodafone name. A travel eSIM connects to one or more of these networks.',
        ],
      },
    },
    faq: [
      { q: 'Is a US plan enough for two weeks in Italy?', a: 'If it includes Italy at full speed, often yes. If it charges a daily pass, a data plan for the whole trip usually costs less.' },
      { q: 'Will my phone switch to a Swiss network at Lake Como?', a: 'It can, near the border. Select an Italian network manually to avoid non EU roaming rates.' },
      { q: 'Does an Italy eSIM cover the Vatican?', a: 'Yes. Vatican City is served by the Italian networks.' },
    ],
  },
};
