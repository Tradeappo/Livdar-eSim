...
export const regions = {
  ...
  africa: {
    ...
    intro: [
      ...
      'Die messbare Nachfrage ist konzentriert statt verteilt. Marokko und Aegypten machen einen sehr großen Teil davon aus, getragen vor allem von europäischen Reisenden.',
    ],
    sections: {
      norden: {
        heading: 'Nordafrika ist gemeint, wenn Reisende Afrika sagen',
        body: [
          'Marokko, Aegypten und Tunesien tragen den größten Teil des Besucherverkehrs und haben die Netze dafür. Städte, Badeorte und die touristischen Hauptrouten sind solide versorgt.',
      ...
      entscheiden: {
        heading: 'Wie Sie entscheiden',
        body: [
          'Für Marokko, Aegypten oder Tunesien allein ist ein Landertarif die saubere Antwort.',
