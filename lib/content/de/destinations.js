...
// eines Reise-eSIM fast ausschliesslich ausserhalb der EU. Wer hier so tut, als
// waere ein eSIM fuer Spanien ein Schnaeppchen, verliert den Leser sofort.
// Deshalb steht auf jeder Seite zuerst die Frage: brauchst du das ueberhaupt.

export const destinations = {
  turkey: {
    angle: 'Kostenluecke ausserhalb der EU plus IMEI-Registrierung',
    ...
    sections: {
      ...
      netz: {
        ...
        body: [
          ...
          'Kappadokien, der Osten und die Bergstrassen sind eine andere Geschichte. Das Netz folgt den Hauptstrassen und den Orten. Wer morgens um fünf zu den Ballons fährt, lädt die Karte besser vorher herunter.',
        ],
      },
      installation: {
  ...
  japan: {
    ...
    sections: {
      netz: {
        heading: 'Netzabdeckung',
        body: [
          'NTT Docomo, KDDI au, SoftBank und Rakuten Mobile tragen das Land. Die ersten drei decken es umfassend ab, inklusive Shinkansen-Strecken und grossem Teil der U-Bahn. Rakuten ist ausserhalb der Städte deutlich dünner.',
      ...
      grenzen: {
        heading: 'Was ein Daten-eSIM nicht kann',
        body: [
          'Keine japanische Nummer. Das wiegt in Japan schwerer als anderswo, weil manche Restaurantplattformen, Ticketseiten und fast alle Lieferdienste ohne inländische Nummer keine Buchung abschliessen.',
    ...
    faq: [
      ...
      { q: 'In welchem Netz bin ich?', a: 'Das hängt vom Tarif ab, nicht vom Land. Frag vor dem Kauf nach, der Unterschied zwischen Docomo und Rakuten ist ausserhalb der Städte real.' },
  ...
  'united-states': {
    angle: 'Deutsche Tagespauschalen fuer die USA sind der konkrete Vergleichspunkt',
    h1: 'eSIM für die USA',
    ...
    intro: [
      'Die USA sind für deutsche Mobilfunkkunden ein klassisches Zusatzoptionsziel. Die grossen Anbieter verkaufen Tagespässe oder Auslandspakete, und die sind je nach Tarif zwischen erträglich und teuer.',
    ...
    sections: {
      ...
      netz: {
        ...
        body: [
          'Verizon und AT&T haben die grösste Reichweite im ländlichen Raum. T-Mobile US hat das stärkste 5G in den Städten und hat viel aufgeholt, aber nicht alles.',
    ...
    faq: [
      { q: 'Funktioniert das in den Nationalparks?', a: 'Am Besucherzentrum und an der Hauptstrasse oft, auf den Trails selten. Kein Netz deckt das Hinterland ab. Offline-Karten laden.' },
  ...
  'united-arab-emirates': {
    angle: 'VoIP-Sperre ist fuer deutsche Reisende die entscheidende Information',
    h1: 'eSIM für die VAE',
    ...
    sections: {
      ...
      netz: {
        ...
        body: [
          ...
          'Die Versorgung in den grossen Malls und in der Metro ist geplant und nicht zufällig, und das merkt man.',
        ],
      },
      kosten: {
        heading: 'Warum nicht einfach roamen',
        body: [
          'Die Emirate liegen ausserhalb jeder Roaming-Regelung, von der europäische Reisende profitieren. Tagespässe in die Golfregion gehören bei deutschen Anbietern zu den teuersten Posten der Preisliste.',
        ],
      },
      installation: {
        heading: 'Wann installieren',
  ...
  thailand: {
    ...
    metaDescription: 'Thailändische Touristen-SIMs sind billig und grosszügig. Ein Reise-eSIM lohnt sich trotzdem in bestimmten Fällen. Hier steht, in welchen.',
    ...
    sections: {
      ...
      netz: {
        heading: 'Netzabdeckung',
        body: [
          'AIS und TrueMove H decken das Land gut ab, einschliesslich der Inseln, auf die es ankommt: Phuket, Samui, Phi Phi, Krabi. NT ist dünner.',
      ...
      kosten: {
        ...
        body: [
          'Thailand liegt ausserhalb jeder für deutsche Tarife inkludierten Zone. Tagespässe nach Südostasien sind gemessen daran, was dasselbe Geld vor Ort kauft, teuer.',
        ],
      },
    },
    faq: [
  ...
  'united-kingdom': {
    angle: 'Fuer deutsche Tarife ist UK oft weiterhin inklusive, also erst pruefen',
    h1: 'eSIM für Grossbritannien',
    title: 'eSIM Grossbritannien: prüfe zuerst, ob dein Tarif es schon enthält',
    metaDescription: 'Viele deutsche Anbieter führen Grossbritannien weiterhin in der EU-Zone. Prüfe das zuerst. Wenn nicht, ist ein Reise-eSIM die günstigere Lösung.',
    sectionOrder: ['intro', 'pruefen', 'tarifstand', 'netz', 'installation', 'grenzen', 'alternativen', 'faq'],
    intro: [
      'Grossbritannien ist seit dem Austritt aus dem Binnenmarkt formal kein EU-Roaming-Land mehr. Praktisch haben viele deutsche Anbieter das Vereinigte Königreich freiwillig in ihrer EU-Zone gelassen.',
    ...
    sections: {
      pruefen: {
        ...
        body: [
          'Öffne die Tarifübersicht deines Anbieters und such nach der Länderliste deiner EU-Option. Steht Grossbritannien darin, brauchst du für ein Wochenende in London nichts weiter.',
      ...
      netz: {
        heading: 'Netzabdeckung',
        body: [
          'EE, Vodafone UK, O2 und Three UK tragen das Land. Städte, Autobahnen und die grossen Bahnstrecken sind gut versorgt. EE hat historisch die grösste Fläche.',
          'Ländliches Wales, die schottischen Highlands und Teile des Südwestens haben echte Funklöcher. Die Strecke London nach Edinburgh reisst auf jedem Netz mehrfach ab.',
        ],
      },
      installation: {
        heading: 'Wann installieren',
      ...
      alternativen: {
        ...
        body: [
          'Britische Prepaid-Karten sind billig, in jedem Supermarkt erhältlich und geben dir eine echte Nummer. Wer regelmässig dort ist oder wochenlang bleibt, nimmt die.',
          'Für eine Kurzreise mit einem Handy, das ohnehin funktioniert, ist ein eSIM das, was du vom Sofa aus einrichtest.',
        ],
      },
    },
    faq: [
      { q: 'Gilt mein EU-Roaming in Grossbritannien?', a: 'Bei vielen deutschen Anbietern ja, freiwillig. Verlass dich nicht darauf, sondern schau in die Länderliste deiner Option.' },
      { q: 'Wie ist das Netz im Zug?', a: 'Auf jedem Netz lückenhaft. London nach Edinburgh reisst mehrfach ab. Lade vorher herunter, was du brauchst.' },
      { q: 'Bekomme ich damit eine britische Nummer?', a: 'Nein. Dafür brauchst du eine britische SIM-Karte.' },
    ],
  },

  switzerland: {
    angle: 'Fuer Deutschland das wichtigste Ziel ueberhaupt, wegen der Grenzlage',
    ...
    sections: {
      grenze: {
        heading: 'Das Grenzproblem ist grösser, als es klingt',
        body: [
      ...
      netz: {
        heading: 'Netzabdeckung',
        body: [
          'Swisscom, Sunrise und Salt versorgen das Land auf einem Niveau, das im europäischen Vergleich ungewöhnlich ist, inklusive der meisten Alpentäler, der Bergbahnen und der Strassentunnel.',
          'Swisscom hat in den Bergen die grösste Tiefe. Wer wandert statt Städte anzusehen, für den ist dieser Unterschied die Nachfrage wert.',
        ],
      },
      installation: {
        heading: 'Wann installieren',
    ...
    faq: [
      { q: 'Gilt EU-Roaming in der Schweiz?', a: 'Nein. Die Schweiz ist weder EU noch EWR-Roaming-Zone. Manche deutschen Tarife schliessen sie freiwillig ein, viele nicht.' },
      ...
      { q: 'Funktioniert es auf den Bergbahnen?', a: 'Grösstenteils ja, die Schweizer Abdeckung in den Alpen ist ungewöhnlich gut. Tunnel und hohe Täler reissen trotzdem ab.' },
    ],
  },

  bali: {
    angle: 'Ankunftsreibung, nicht Netzqualitaet',
    h1: 'eSIM für Bali',
    title: 'eSIM Bali: am Schalter in Denpasar vorbei',
    metaDescription: 'Indonesische SIM-Karten müssen gegen den Pass registriert werden. Der Schalter in Denpasar weiss das. Ein Reise-eSIM bringt dich vorher online.',
    ...
    sections: {
      registrierung: {
        ...
        body: [
          'Indonesien verlangt, dass Prepaid-Nummern gegen ein Ausweisdokument registriert werden. Für Besucher heisst das: Pass über den Tresen, warten, bis eingetippt ist.',
      ...
      netz: {
        ...
        body: [
          ...
          'Canggu, Seminyak, Ubud und Uluwatu sind gut versorgt. Sidemen, die Gegend um Munduk und die Strasse nach Kintamani nicht durchgängig.',
        ],
      },
      installation: {
        heading: 'Wann installieren',
      ...
      alternativen: {
        ...
        body: [
          'Ein Telkomsel-Touristenpaket ist billig und grosszügig. Wer einen Monat in Bali arbeitet, fährt damit vermutlich besser.',
    ...
    faq: [
      ...
      { q: 'Funktioniert es in Ubud und im Norden?', a: 'In Ubud ja. Im Norden und auf den Bergstrassen ist jedes Netz dünner, Telkomsel am wenigsten.' },
      { q: 'Reicht es zum Arbeiten?', a: 'Für Anrufe und E-Mail ja, wenn der Tarif Hotspot erlaubt. Für grosse Uploads ist das Coworking-WLAN in Canggu schneller.' },
      { q: 'Wie sieht es auf Nusa Penida oder den Gilis aus?', a: 'Schwächer als auf der Südhalbinsel. In den Hauptorten und an den Anlegern hast du Empfang, auf den Klippenstrassen und während der Überfahrt nicht durchgängig. Lade Karte und Buchungen vor dem Ablegen herunter.' },
    ],
  },
};
