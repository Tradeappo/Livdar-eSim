export const guides = {
  'how-esim-works': {
    ...
    sections: {
      unterschied: {
        ...
        body: [
          'Du kannst ein Profil von überall installieren, wo Internet ist. Das heisst, du bist in einem fremden Netz, bevor du dein eigenes Land verlässt.',
  ...
  'esim-vs-roaming': {
    ...
    metaDescription: 'In der EU ist Roaming enthalten. Ausserhalb entscheidet eine Rechnung, die zwei Minuten dauert. So geht sie.',
    intro: [
      'Für deutsche Tarife ist die Antwort in der EU fast immer Roaming, weil es nichts kostet. Ausserhalb der EU ist sie fast immer das Gegenteil.',
    ...
    sections: {
      ...
      ausserhalb: {
        heading: 'Ausserhalb wird es schnell teuer',
        body: [
          'Die Türkei, die Schweiz, Grossbritannien bei manchen Anbietern, die Golfregion, Asien und Nordamerika sind alle Zusatzoptionsziele.',
    ...
    faq: [
      { q: 'Ist Roaming immer teurer?', a: 'Nein. In der EU ist es enthalten, und manche Tarife schliessen deutlich mehr Länder ein, als die Leute denken. Erst nachsehen.' },
      ...
      { q: 'Was ist mit eingehenden Anrufen?', a: 'Die kommen wie gewohnt auf deiner deutschen Nummer an. In der EU ist das Annehmen enthalten, ausserhalb nicht automatisch.' },
    ],
  },
