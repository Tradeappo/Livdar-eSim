...
export const REGIONS = [
  ...
  { id: 'southeast-asia', names: { en: 'Southeast Asia', de: 'Südostasien', ro: 'Asia de Sud-Est', fr: 'Asie du Sud-Est', it: 'Sud-est asiatico', es: 'Sudeste Asiatico', nl: 'Zuidoost-Azie', pl: 'Azja Poludniowo-Wschodnia', pt: 'Sudeste Asiatico' } },
  ...
  { id: 'south-america', names: { en: 'South America', de: 'Südamerika', ro: 'America de Sud', fr: 'Amerique du Sud', it: 'Sud America', es: 'America del Sur', nl: 'Zuid-Amerika', pl: 'Ameryka Poludniowa', pt: 'America do Sul' } },
...
export const DESTINATIONS = [
  // Europe
  D('turkey', 'TR', 'europe', '+90', ['Turkcell', 'Vodafone Turkiye', 'Turk Telekom'], { de: 'Türkei', ro: 'Turcia', fr: 'Turquie', it: 'Turchia', es: 'Turquia', nl: 'Turkije', pl: 'Turcja', pt: 'Turquia' }, ['tourism', 'expensive-roaming', 'non-eu']),
  D('spain', 'ES', 'europe', '+34', ['Movistar', 'Vodafone Espana', 'Orange (MasOrange)', 'Digi'], { de: 'Spanien', ro: 'Spania', fr: 'Espagne', it: 'Spagna', es: 'Espana', nl: 'Spanje', pl: 'Hiszpania', pt: 'Espanha' }, ['tourism', 'eu']),
  ...
  D('united-kingdom', 'GB', 'europe', '+44', ['EE', 'Vodafone UK', 'O2', 'Three UK'], { de: 'Großbritannien', ro: 'Marea Britanie', fr: 'Royaume-Uni', it: 'Regno Unito', es: 'Reino Unido', nl: 'Verenigd Koninkrijk', pl: 'Wielka Brytania', pt: 'Reino Unido' }, ['business', 'tourism', 'non-eu', 'expensive-roaming']),
  ...
  D('austria', 'AT', 'europe', '+43', ['A1', 'Magenta', 'Drei'], { de: 'Österreich', ro: 'Austria', fr: 'Autriche', it: 'Austria', es: 'Austria', nl: 'Oostenrijk', pl: 'Austria', pt: 'Austria' }, ['tourism', 'eu']),
  ...
  D('romania', 'RO', 'europe', '+40', ['Orange Romania', 'Vodafone Romania', 'Digi', 'Telekom Romania'], { de: 'Rumänien', ro: 'Romania', fr: 'Roumanie', it: 'Romania', es: 'Rumania', nl: 'Roemenie', pl: 'Rumunia', pt: 'Romenia' }, ['eu']),
  ...
  D('denmark', 'DK', 'europe', '+45', ['TDC', 'Telenor', 'Telia', '3'], { de: 'Dänemark', ro: 'Danemarca', fr: 'Danemark', it: 'Danimarca', es: 'Dinamarca', nl: 'Denemarken', pl: 'Dania', pt: 'Dinamarca' }, ['eu']),
  ...
  D('south-korea', 'KR', 'asia', '+82', ['SK Telecom', 'KT', 'LG Uplus'], { de: 'Südkorea', ro: 'Coreea de Sud', fr: 'Coree du Sud', it: 'Corea del Sud', es: 'Corea del Sur', nl: 'Zuid-Korea', pl: 'Korea Poludniowa', pt: 'Coreia do Sul' }, ['tourism', 'expensive-roaming']),
  ...
  // Africa
  D('egypt', 'EG', 'africa', '+20', ['Vodafone Egypt', 'Orange Egypt', 'Etisalat Misr', 'WE'], { de: 'Ägypten', ro: 'Egipt', fr: 'Egypte', it: 'Egitto', es: 'Egipto', nl: 'Egypte', pl: 'Egipt', pt: 'Egito' }, ['tourism', 'expensive-roaming']),
  ...
  D('south-africa', 'ZA', 'africa', '+27', ['Vodacom', 'MTN', 'Cell C', 'Telkom'], { de: 'Südafrika', ro: 'Africa de Sud', fr: 'Afrique du Sud', it: 'Sudafrica', es: 'Sudafrica', nl: 'Zuid-Afrika', pl: 'Republika Poludniowej Afryki', pt: 'Africa do Sul' }, ['tourism', 'business']),
  ...
  D('ethiopia', 'ET', 'africa', '+251', ['Ethio Telecom', 'Safaricom Ethiopia'], { de: 'Äthiopien', ro: 'Etiopia', fr: 'Ethiopie', it: 'Etiopia', es: 'Etiopia', nl: 'Ethiopie', pl: 'Etiopia', pt: 'Etiopia' }, ['business']),
...
// The flag emoji, derived from the ISO code rather than stored.
//
// Derived because a stored emoji is a second source of truth that can disagree
// with the country it is attached to, and because a wrong flag next to a
// country name is the kind of mistake a reader notices immediately. Two regional
// indicator letters, nothing else. Where a destination has no two letter code,
// there is no flag and the caller renders none.
export function flagFor(destination) {
  const code = destination && destination.iso2;
...
// German display names carry umlauts, but the URLs were published from the
// transliterated spelling (tuerkei, not turkei). These slugs are pinned so a
// spelling fix in the display name can never move a live URL.
...
export function destinationSlug(destination, locale) {
  ...
  const pinned = PINNED_SLUGS[locale] && PINNED_SLUGS[locale][destination.id];
