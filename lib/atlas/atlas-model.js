...
import { forCity as hoodsForCity, sourceRecord as hoodSource, store as hoodStore } from './neighbourhoods.js';
...
function holidaysModel(page, pack) {
  ...
  return {
    ...
    title: cp.title({ c: bare, year: d.year }),
...
function subdivisionHolidaysModel(page, pack) {
  ...
  return {
    ...
    title: cp.regionTitle({ r, c, year: d.year }),
