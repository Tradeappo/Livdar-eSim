...
export const SURFACE_FLOOR = {
  areas: 20, stay: 20, work: 20, move: 20, sport: 20, tools: 20, pulse: 20, community: 10,
};
...
export const SURFACE_CEILING = {
  areas: 50, pulse: 50, stay: 50, work: 40, move: 40, sport: 40, tools: 40,
  community: 30, climate: 40, transport: 40, safety: 40, connectivity: 40,
};
