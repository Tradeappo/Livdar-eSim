...
export const TOOLS = [
  ...
  },
  {
    ...
    sources: ['rent-level-verified'],
    leadsTo: ['rental-lead'],
    complexity: 'small',
    note: 'The largest winnable volume of the calculators, and it needs a rent level rather than a rent index. Eurostat publishes an index and an inflation rate and no level, so building it off what exists would produce a tool that cannot answer its own question. It waits for rent-level-verified.',
  },
  {
