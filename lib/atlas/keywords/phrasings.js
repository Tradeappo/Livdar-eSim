...
export const PHRASINGS = {
  // High value verticals. Written for English first and measured before the
  // other languages are written: a phrasing that turns out to have no volume
  // in English is not worth translating into nine markets.
  'cost-of-living.city-vs-market': {
    en: ['cost of living in {city} vs {homeCountry}', 'is {city} cheaper than {homeCountry}', '{city} vs {homeCountry} cost of living'],
  },
  'rents.city': {
    en: ['rent in {city}', 'average rent in {city}', 'apartment rent {city}', 'how much is rent in {city}'],
    de: ['miete in {city}', 'durchschnittsmiete {city}', 'wohnung mieten {city}'],
  ...
  'rents.neighbourhood': {
    en: ['rent in {neighbourhood} {city}', '{neighbourhood} rent prices'],
    de: ['miete {neighbourhood} {city}'],
  },
  // Measured 2026-09-23, en-US: all four original phrasings returned a volume
  // of zero on every city in the sample, including Shanghai, Beijing and
  // Shenzhen. The city level buying intent does not exist as a search in this
  // market; the country level one does. The city phrasings are kept here,
  // commented, so nobody measures them again.
  //   dead: buying property in {city}, house prices in {city},
  //         cost to buy an apartment in {city}, property prices {city}
  'property.city-buy': {
    de: ['immobilie kaufen in {city}', 'immobilienpreise {city}', 'wohnung kaufen {city}'],
  },
  'work.city-jobs': {
    en: ['jobs in {city}', 'working in {city}', 'job market in {city}', 'finding a job in {city}'],
    de: ['jobs in {city}', 'arbeiten in {city}', 'arbeitsmarkt {city}'],
  },
  'work.country-working': {
    en: ['working in {country} as a foreigner', 'can i work in {country}', 'work permit {country}'],
    de: ['in {country} arbeiten als ausländer', 'arbeitserlaubnis {country}'],
  },
  'visas.country-residency': {
    en: ['residency in {country}', 'how to get residency in {country}', '{country} residence permit'],
    de: ['aufenthaltstitel {country}', 'daueraufenthalt {country}'],
  },
  'visas.country-digital-nomad': {
    en: ['{country} digital nomad visa', 'remote work visa {country}'],
    de: ['digital nomad visum {country}', 'remote work visum {country}'],
  },
  'visas.country-work-permit': {
    en: ['{country} work visa', 'work visa requirements {country}'],
    de: ['arbeitsvisum {country}'],
  },
  'taxes.country': {
    en: ['taxes in {country}', 'income tax in {country}', '{country} tax rates for foreigners'],
    de: ['steuern in {country}', 'einkommensteuer {country}'],
  },
  // Measured 2026-09-23, en-US: 'working remotely from {country} taxes' is
  // dead on every country in the sample, and 'tax residency {country}' reached
  // 10 at best. The intent is real but people phrase it through the country
  // tax page, which 'taxes in {country}' already covers at 300 to 450.
  'taxes.country-remote-work': {
    en: ['tax residency {country}'],
    de: ['remote arbeiten aus {country} steuern', 'steuerliche ansässigkeit {country}'],
  },
  'banking.country': {
    en: ['opening a bank account in {country}', 'bank account {country} for foreigners', 'best bank in {country} for expats'],
    de: ['konto eröffnen in {country}', 'bankkonto {country} ausländer'],
  },
  'health.country': {
    en: ['health insurance in {country}', 'healthcare in {country} for foreigners', '{country} health system'],
    de: ['krankenversicherung in {country}', 'gesundheitssystem {country}'],
  },
  'health.city': {
    en: ['hospitals in {city}', 'healthcare in {city}'],
    de: ['krankenhäuser in {city}', 'ärzte in {city}'],
  },
  'education.city-universities': {
    en: ['studying in {city}', 'universities in {city}', 'student life in {city}'],
    de: ['studieren in {city}', 'universitäten {city}'],
  },
  'education.city-schools': {
    en: ['international schools in {city}', 'schools in {city} for expats'],
    de: ['internationale schulen {city}'],
  },
  'relocation.country': {
    en: ['moving to {country}', 'living in {country} as an expat', 'relocating to {country}'],
    de: ['auswandern nach {country}', 'leben in {country}'],
  },
  'comparisons.city-vs-home': {
    en: ['{city} vs {homeCity}', 'living in {city} vs {homeCity}'],
  },
  'connectivity.country-sim-gap': {
    en: ['internet in {country}', 'mobile data in {country}', 'wifi in {country}'],
  },
  'transport.city-getting-around': {
    en: ['public transport in {city}', 'getting around {city}', '{city} metro'],
    de: ['öffentliche verkehrsmittel {city}', 'nahverkehr {city}'],
  },
  'weather.city-month': {
