...
export function cityMonthModel(ds, page, isLive) {
  ...
  return finish(ds, page, {
    ...
    breadcrumbs: [{ name: land }, { name, href: isLive(guideKey) ? pathFor(ds, { family: 'city-guide', locale: l, entity: page.entity }) : null }, { name: mon }],
...
export function airportModel(ds, page, isLive) {
  ...
  return finish(ds, page, {
    ...
    breadcrumbs: [{ name: t.airports }, { name: a.name }],
    sections, facts, faq, links,
