...
export const NODES = {
  ...
  // Added 2026-09-24. A German Land and a Spanish autonomous community are
  // real entities in this model and not a detail of the country, because the
  // thing a reader most often wants is set at that level: every German public
  // holiday is state law, and `feiertage nrw 2026` outsells the national term
  // two to one.
  subdivision: { key: 'iso3166_2', from: 'the holiday source subdivision files', has: ['public holidays', 'in country'] },
