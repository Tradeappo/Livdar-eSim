...
export function toolSpec(toolId, { language = 'en', unit = 'index-eu27-100', market = null, title = null } = {}) {
  ...
  // The card's heading is the tool's own localised name, which the page model
  // already holds, rather than a second string saying the same thing.
  const base = { id: toolId, interactive: true, mode, language, home, title };
