...
export const VERTICAL_PRIORITY = {
  ...
  activities: 'medium',
  sport: 'medium', community: 'medium', services: 'medium', places: 'medium',
...
export const FAMILIES = {
  ...
  'neighbourhoods.city-best-for': {
    ...
    requiredSources: ['geonames-cities', 'neighbourhood-facts-verified', 'rent-index-verified'], minWords: 340,
  ...
  'work.city-jobs-category': {
    ...
    requiredSources: ['geonames-cities', 'salary-data-verified', 'work-rules-verified'], minWords: 320,
    ...
    evidenceState: 'measured',
    measurementCaveat: 'measured in the wrong market; needs local language measurement before it earns a market gate',
    leadsTo: ['job-listing', 'relocation-service'],
    aeo: ['fact-table', 'eligibility'],
    indexPolicy: 'always',
    ...v(0.8, 0.9, 0.7, 0.85, 0.7, 0.75),
  },
