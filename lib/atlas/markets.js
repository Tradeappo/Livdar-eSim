...
//
// It does not change any market state on its own, and it must not be read as
// proof that a market is empty. The seed is one English language site, so a
...
// for these families, and enumerating them there on the strength of the eSIM
// research alone would be an assumption rather than a measurement. Each needs
// a seed in its own language before it is judged.
