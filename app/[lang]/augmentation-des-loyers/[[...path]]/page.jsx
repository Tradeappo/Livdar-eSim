// Livdar Atlas data route for /{lang}/augmentation-des-loyers/. See components/atlas/atlasPageRoute.jsx.
import '../../../atlas.css';
import { makeAtlasPageRoute } from '../../../../components/atlas/atlasPageRoute.jsx';

const route = makeAtlasPageRoute('augmentation-des-loyers');
