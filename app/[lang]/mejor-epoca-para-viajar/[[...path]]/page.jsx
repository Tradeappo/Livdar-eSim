// Livdar Atlas data route for /{lang}/mejor-epoca-para-viajar/. See components/atlas/atlasPageRoute.jsx.
import '../../../atlas.css';
import { makeAtlasPageRoute } from '../../../../components/atlas/atlasPageRoute.jsx';

const route = makeAtlasPageRoute('mejor-epoca-para-viajar');
