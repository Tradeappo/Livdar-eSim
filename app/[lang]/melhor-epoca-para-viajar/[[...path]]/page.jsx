// Livdar Atlas data route for /{lang}/melhor-epoca-para-viajar/. See components/atlas/atlasPageRoute.jsx.
import '../../../atlas.css';
import { makeAtlasPageRoute } from '../../../../components/atlas/atlasPageRoute.jsx';

const route = makeAtlasPageRoute('melhor-epoca-para-viajar');
