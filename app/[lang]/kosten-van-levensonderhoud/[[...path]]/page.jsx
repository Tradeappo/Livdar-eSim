// Livdar Atlas data route for /{lang}/kosten-van-levensonderhoud/. See components/atlas/atlasPageRoute.jsx.
import '../../../atlas.css';
import { makeAtlasPageRoute } from '../../../../components/atlas/atlasPageRoute.jsx';

const route = makeAtlasPageRoute('kosten-van-levensonderhoud');
